...
use App\Controller\MyWikiController;
use App\Controller\ManageTagsController;
use App\Router;
...
$router->get($url.'/UpdateTag',ManageTagsController::class,'UpdateTag');
$router->post($url.'/TagUpdate',ManageTagsController::class,'TagUpdate');
$router->get($url.'/DeleteTag',ManageTagsController::class,'DeleteTag');
...
$router->get($url.'/UpdateMyWiki',WikiController::class,'showWiki');
...
$router->get($url.'/ManageTags',ManageTagsController::class,'index');
